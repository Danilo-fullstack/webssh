...
<head>
    ...
    <link rel="stylesheet" href="_css/painel.css?v=1.2">
...
<body>
    ...
    <section class="corpo">
        <div class="bemvindo">
            <h2>Olá <span><?php echo $_SESSION['nome']; ?></span>! <span  class="color_none">Bem vindo</span> ao site</h2>
            <h3>Espero que curta nosso trabalho</h3>
        </div>
    </section>
    <footer class="rodape">
