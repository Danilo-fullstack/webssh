...
<head>
    ...
    <title>Web SSH</title>
    <link rel="stylesheet" href="_css/style.css?v=1.3">
    <!--<link rel="stylesheet" href="_css/login.css?v=1.0">-->
    <link rel="stylesheet" href="_css/style_new_login.css?v=1.2">
        ...
        <div class="box_login">
            ...
            <form action="login.php" method="POST">
                <div class="input_block">
                    <label for="tnome">Email</label>
                    <input type="text" id="tnome" name="cemail">
                </div>
                <div class="input_block">
                    <label for="tsenha">Senha</label>
                    <input type="password" id="tsenha" name="csenha">
                </div>
                <button type="submit" class="botao">Entrar</button>
                <p>ou</p>
                <a href="cadastro.php" class="botao">Cadastrar</a>            <!--<button class="botao" onclick="window.location.href = 'cadastrar.php'">Cadastrar</button>-->
            </form>
        </div>
    </section>
    <footer class="rodape">
