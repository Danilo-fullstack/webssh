...
<head>
    ...
    <link rel="stylesheet" href="_css/cadastro.css?v=1.2">
        ...
        <div class="box_cadastro">
            ...
            <form action="cadastrar.php" method="POST">
                <div class="input_cadastro">
                    ...
                    <input type="text" id="tnome" name="cnome">
                </div>
                <div class="input_cadastro">
                    <label for="temail">Email</label>
                    <input type="email" id="temail" name="cemail">
                </div>
                <div class="input_cadastro">
                ...
                <p>ou</p>
                <a class="botao" type="text" href="login_index.php">Logar</button>
            </form>
        </div>
    </section>
    <footer class="rodape">
