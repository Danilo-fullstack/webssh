...
<head>
    ...
    <link rel="stylesheet" href="_css/apps.css?v=1.3">
...
<body>
    ...
    <section class="corpo">
        <div class="bemvindo">
            <a href="_download/aplicativo-de-internet.apk" download="App-de-Internet.apk"><img src="_img/cloudssh.jpg" id="app-cloud"></a>
            <p><a href="_download/aplicativo-de-internet.apk" download="App-de-Internet.apk">App de Internet</a></p>
        </div>
    </section>
    <footer class="rodape">
